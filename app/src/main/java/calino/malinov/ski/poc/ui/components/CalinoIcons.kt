...
object CalinoIcons {
    ...
    val Settings: ImageVector by lazy { icon("settings") { pathWithoutFill { circle(12f, 12f, 3f); moveTo(19.4f, 15f); lineTo(21.2f, 16.4f); lineTo(18.4f, 19.2f); lineTo(17f, 17.4f); curveTo(16.2f, 17.9f, 15.3f, 18.3f, 14.3f, 18.6f); lineTo(14f, 21f); horizontalLineTo(10f); lineTo(9.7f, 18.6f); curveTo(8.7f, 18.3f, 7.8f, 17.9f, 7f, 17.4f); lineTo(5.6f, 19.2f); lineTo(2.8f, 16.4f); lineTo(4.6f, 15f); curveTo(4.1f, 14.2f, 3.7f, 13.3f, 3.4f, 12.3f); lineTo(1f, 12f); verticalLineTo(8f); lineTo(3.4f, 7.7f); curveTo(3.7f, 6.7f, 4.1f, 5.8f, 4.6f, 5f); lineTo(2.8f, 3.6f); lineTo(5.6f, .8f); lineTo(7f, 2.6f); curveTo(7.8f, 2.1f, 8.7f, 1.7f, 9.7f, 1.4f); lineTo(10f, -1f); horizontalLineTo(14f); lineTo(14.3f, 1.4f); curveTo(15.3f, 1.7f, 16.2f, 2.1f, 17f, 2.6f); lineTo(18.4f, .8f); lineTo(21.2f, 3.6f); lineTo(19.4f, 5f); curveTo(19.9f, 5.8f, 20.3f, 6.7f, 20.6f, 7.7f); lineTo(23f, 8f); verticalLineTo(12f); lineTo(20.6f, 12.3f); curveTo(20.3f, 13.3f, 19.9f, 14.2f, 19.4f, 15f) } } }
    val ListChecks: ImageVector by lazy { icon("list-checks") { pathWithoutFill { lineTo(8f, 6f); moveTo(11f, 6f); horizontalLineTo(21f); moveTo(11f, 12f); horizontalLineTo(21f); moveTo(11f, 18f); horizontalLineTo(21f); moveTo(3f, 6f); lineTo(4.5f, 7.5f); lineTo(7f, 4.5f); moveTo(3f, 12f); lineTo(4.5f, 13.5f); lineTo(7f, 10.5f); moveTo(3f, 18f); lineTo(4.5f, 19.5f); lineTo(7f, 16.5f) } } }
