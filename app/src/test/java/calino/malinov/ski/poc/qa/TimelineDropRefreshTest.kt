...
class TimelineDropRefreshTest {
    ...
    fun `HomeScreen takes its events as a parameter rather than reading the repository`() {
        val home = File("src/main/java/calino/malinov/ski/poc/ui/home/HomeScreen.kt").readText()
        assertTrue(
        ...
        val host = File("src/main/java/calino/malinov/ski/poc/MainActivity.kt").readText()
        assertTrue(
