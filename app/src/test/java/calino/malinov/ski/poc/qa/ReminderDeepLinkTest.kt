...
class ReminderDeepLinkTest {
    ...
    fun `rubbish and foreign uris parse to null`() {
        ...
        assertNull(ReminderDeepLinks.parse("calino.malinov.ski.poc://ai-photo-import"))
        assertNull(ReminderDeepLinks.parse("calino.malinov.ski.poc://reminder/journal?id=1"))
        assertNull(ReminderDeepLinks.parse("calino.malinov.ski.poc://reminder/event"))
    }
